...
if __name__ == '__main__':
    ...
    #    Eg: image_url = 'http://ksmartstatic.sify.com/cmf-1.0.0/appflow/bawarchi.com/Image/oeturjecjjdah_bigger.jpg(17 kB)'
    # 3) Fill the 'my_name' variable with your name so that you know the posts you have created
    image_url = 'https://thestayathomechef.com/wp-content/uploads/2018/07/Homemade-Ice-Cream-1-small.jpg'
    my_name = 'Devyash Bordia'
